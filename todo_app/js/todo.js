...
function get_todos() {
    ...
    /*If the input is not null then JSON.pase will communicate with the web browser
...
/*This function keeps the tasks permanetly displayed displayed on the screen*/
function show() {
